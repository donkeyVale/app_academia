        ...
        <AnimatePresence initial={false}>
          {menuOpen && (
            <motion.nav
              ...
              className="mt-1 ml-auto mr-4 flex w-full max-w-[220px] origin-top-right flex-col gap-1 rounded-xl border border-[#dbeafe] bg-[#f1f5f9] px-3 py-2 text-sm shadow-md"
            >
